...
{deleteLoading && (
      ...
      filteredAndSortedTransactions.map((transaction)=>(
       <TableRow key={transaction.id}>
        ...
        <TableCell className="capitalize">
          <span style={{background:categoryColors[transaction.category],}} className='px-2 py-1 text-white text-sm rounded'>
  ...
  <Tooltip>
    <TooltipTrigger>
    <Badge variant="outline"className='gap-1 bg-purple-100 text-purple-700 hover:bg-purple-400 hover:text-white' >
      <RefreshCw className=' h-3 w-3'/>
      {RECURRING_INTERVELS[ transaction.recurringInterval]}
